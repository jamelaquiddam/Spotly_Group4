...
<p class="auth-footer">Need an account? <a href="register.php">Register here</a> · <a href="resend_verification.php">Resend verification email</a></p></section></main><script src="../assets/js/main.js"></script></body></html>
